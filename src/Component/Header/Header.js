...
render() {
    ...
    inPutFields = (
        <React.Fragment>
            ...
            <input name="password" type="password" value={this.state.password} onChange={this.signInChangeHandler}name="password" className="form-control" id="inputPassword4" placeholder="Password" />
